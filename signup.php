    ...
    <div class="row">
      <div class="col-md-4 offset-md-4 form-wrapper auth">
        ...
        <form action="signup.php" method="post">
		  ...
		  <div class="form-group">
            <label>Names</label>
            <input type="text" name="names" class="form-control form-control-lg" value="<?php echo $names; ?>">
          </div>
		  <div class="form-group">
            <label>Phone Number</label>
            <input type="text" name="address" class="form-control form-control-lg" value="<?php echo $names; ?>">
          </div>
          <div class="form-group">
